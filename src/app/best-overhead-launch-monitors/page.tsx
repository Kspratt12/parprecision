...
const article = getArticleBySlug("best-overhead-launch-monitors");
...
export const metadata: Metadata = article
  ? {
      ...
      alternates: { canonical: "https://parprecision.com/best-overhead-launch-monitors" },
      openGraph: {
        title: article.title,
        description: article.description,
        type: "article",
...
export default function OverheadLaunchMonitorsPage() {
