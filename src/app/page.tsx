    ...
    <>
      ...
      <section className="bg-gradient-to-br from-primary to-primary-dark py-16 md:py-20">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-3">Get the Free Buying Guide</h2>
          <p className="text-white/80 mb-8">Our top picks, room requirements, and money-saving tips - delivered to your inbox.</p>
