...
const navigation = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: "Garmin Approach R10 Review", href: "/reviews/garmin-approach-r10" },
      { name: "Bushnell Launch Pro Review", href: "/reviews/bushnell-launch-pro" },
      { name: "FlightScope Mevo Plus Review", href: "/reviews/flightscope-mevo-plus" },
